      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          child:  GestureDetector(
            onTap: () {
              // Navigate to a new page or screen when the card is clicked
              Navigator.push(
                context,
                MaterialPageRoute(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Icon(Icons.arrow_forward, color: Colors.black), // Add an icon to show more details
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Icon(Icons.payment, color: Colors.black), // Icon for Payment
                        const SizedBox(width: 10),
                        Text(
